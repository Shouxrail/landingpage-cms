...
export default function Pages({ pages }: PagesProps) {
    ...
    const handleCreate = (e: React.FormEvent) => {
        ...
        router.post('/admin/pages', {
            ...
            onError: (errors: any) => {
                setError(errors.slug || "Failed to create page");
                setIsCreating(false);
            },
            onFinish: () => {
                setIsCreating(false);
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="stats glass border border-white/10 text-white">
                        <div className="stat">
                            ...
                            <div className="stat-desc text-white/30 text-xs mt-1">Laravel/MySQL Cluster</div>
                        </div>
                    </div>
                    <div className="stats glass border border-white/10 text-white">
                        <div className="stat">
                        ...
                        {pages.map((page) => (
                            <div key={page.slug} className="card glass border border-white/10 transition-all duration-500 active:scale-95 group shadow-xl overflow-hidden rounded-[3rem]">
                                <div className="card-body p-10">
                                    ...
                                    <h3 className="card-title text-2xl font-black text-white transition-colors mb-2">{page.page_title}</h3>
